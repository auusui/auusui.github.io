...
For eleven weeks of Summer 2020, I had the greatest opportunity to partake in a research and software development project.  I worked under my former professor, Philip Johnson, where he taught me most of the skills in ICS 314 - Software Engineering.  I learned so much during this process, and it gave me a real life experience of what software development is like.  This project was challenging and time-consuming yet very rewarding once you see results.  I learned to scrape websites using Javascript Libraries such as X-Ray, Tatooine, Osmosis, and Puppeteer.  I think that X-Ray was a super easy tool to use if your goal is to grab surface information.  If you want to grab more in depth information like going to the #href source, then Puppeteer was a great tool for that.  I got to experience the libraries' strengths and weaknesses and compare the usage.  I came out of this internship with a better knowledge of what I want to do in the future and I feel confident that I could ace a course on all of the activities we did over this summer.  I think that is what internships are for.  You want to get a taste of what it would be like in a specific field and if you would enjoy doing it.  This is why I was happy to be working on this project because I want other students to be able to experience this.  An internship can assure a student's dream job or steer them to a new direction if it isn't what they enjoy. With unusual circumstances of COVID-19, it was a huge transition taking this internship completely online.  Originally, we were supposed to meet on campus in person every week, but plans changed drastically.  We had zoom and discord meetings 4 days a week and had to find new ways to communicate with our teammates.  I think that this challenge has prepared us more than people would actually admit.  This proves that we can adapt and transition into a whole new level of communication no matter the circumstances.  I feel like people oversee it most times because we can just "talk over the phone" and it will be the same.  I beg to differ because looking at a teammates code through a shared screen is a lot different than going over it in person.  There are also things like distractions that wouldn't be there if it were in person.  I have adapted into a zen mode where I learned to focus my thoughts rather than be distracted by all of my surroundings.  It is super easy to lay off your responsibilities to do them "later", and this is what we overcame.  I think it also matters to be passionate about what you're doing, but that was just a bonus to this internship.  I believe this project can help a lot of students find the path they want to take in life, and I am glad I was able to contribute to this.  
